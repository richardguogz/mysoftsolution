...
namespace MySoft.Data
{
    ...
    /// 数据行
    /// </summary>
    internal class SourceRow : IRowReader
    {
        private DataRow row;
        private IList<string> fieldList;
        ...
        public bool IsDBNull(string name)
        {
            ...
            if (!fieldList.Contains(name.ToLower())) return true;
        ...
        public object GetValue(string name)
        {
            ...
            if (!fieldList.Contains(name.ToLower())) return null;
