...
namespace MySoft.Data
{
    ...
    public class SourceList<T> : ArrayList<T>, ISourceList<T>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public MemoryFrom<T> ToMemory()
        {
            return new MemoryFrom<T>(this.GetDataTable());
        }
        ...
        /// <returns></returns>
        public new ISourceList<T> Add(T item)
        {
            base.Add(item);
            return this;
        }
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public new ISourceList<T> AddRange(IEnumerable<T> collection)
        {
