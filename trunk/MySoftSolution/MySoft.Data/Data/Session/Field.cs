    ...
    public class Field : IField
    {
        ...
        internal string FullName
        {
            get
            {
                ...
                return this.Name + " {0}" + aliasName + "{1}";
            }
        }
        ...
        {
            return new Field("isnull(" + this.Name + "," + DataUtils.FormatValue(value) + ")").As(this.OriginalName);
        }
        ...
        {
            return new Field("replace(" + this.Name + "," + DataUtils.FormatValue(oldValue) + "," + DataUtils.FormatValue(newValue) + ")").As(this.OriginalName);
        }
        ...
        public WhereClip In(QueryCreator creator)
        {
            ...
            FromSection<TempEntity> f = new FromSection<TempEntity>(creator.Table);
