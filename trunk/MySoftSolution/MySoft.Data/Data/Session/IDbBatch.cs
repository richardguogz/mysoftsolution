...
namespace MySoft.Data
{
    interface IDbProcess
    {
        ...
        int Insert<T>(Field[] fields, object[] values, out object retVal) where T : Entity;
        ...
        int Insert<T>(Table table, Field[] fields, object[] values, out object retVal) where T : Entity;
