...
using MySoft.Web.Json;
using MySoft.Web.Converter;
...
namespace MySoft.Web
{
    ...
    public abstract class WebUtils
    {
        ...
        private static void RegisterForAjax(Page page, string urlResource)
        {
            ...
            jslist.Add(page.ClientScript.GetWebResourceUrl(typeof(MySoft.Web.UI.AjaxPage), "MySoft.Web.Resources.request.js"));
            jslist.Add(page.ClientScript.GetWebResourceUrl(typeof(MySoft.Web.UI.AjaxPage), "MySoft.Web.Resources.ajax.js"));
        ...
        {
            bool success;
            if (ConverterFactory.Converters.ContainsKey(typeof(T)))
            {
                object obj = ConverterFactory.Converters[typeof(T)].ConvertTo(value, out success);
