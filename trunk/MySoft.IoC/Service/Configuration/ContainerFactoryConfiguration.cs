...
namespace MySoft.IoC.Service
{
    ...
    /// </summary>
    public class ContainerFactoryConfiguration : ConfigurationBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ContainerFactoryConfiguration GetConfig()
        {
            object obj = ConfigurationManager.GetSection("serviceFramework/castleFactory");

            if (obj != null)
                return (ContainerFactoryConfiguration)obj;
            else
                return null;
        }
