...
using KiShion.Web.Json.Utilities;
using System.Xml;
using KiShion.Web.Json.Converters;

namespace KiShion.Web.Json
{
	/// <summary>
	...
	public static class JavaScriptConvert
	{
		...
		static JavaScriptConvert()
		{
			...
			InitialJavaScriptDateTicks = (new DateTime(1970, 1, 1).ToLocalTime()).Ticks;
