    ...
    public class AjaxRequest
    {
        ...
        public void SendRequest()
        {
            try
            {
                ...
                if (!AjaxProcess)
                {
                    WebUtils.RegisterPageCssFile(info.CurrentPage, info.CurrentPage.ClientScript.GetWebResourceUrl(typeof(AjaxPage), "KiShion.Web.Resources.pager.css"));

                    //需要启用模板加载
                    if (info.EnableAjaxTemplate)
                    {
                        WebUtils.RegisterPageJsFile(info.CurrentPage, info.CurrentPage.ClientScript.GetWebResourceUrl(typeof(AjaxPage), "KiShion.Web.Resources.template.js"));
                    }
