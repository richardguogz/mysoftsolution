namespace KiShion.Web.Converter
{
    ...
    public class ObjectBuilder<T> : ObjectBuilder
    {
        ...
        public new T Bind(CallbackParams callbackParams)
        {
            return (T)base.Bind(callbackParams);
        }
    }
    ...
    public class ObjectBuilder
    {
        ...
        public object Bind(CallbackParams callbackParams)
        {
            NameValueCollection values = new NameValueCollection();
            foreach (KeyValuePair<string, CallbackParam> pair in callbackParams.KeyValues)
            {
