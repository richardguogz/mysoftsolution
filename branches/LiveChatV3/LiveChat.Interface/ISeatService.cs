...
namespace LiveChat.Interface
{
    public interface ISeatService : ICommonService
    {
        ...
        /// <returns></returns>
        bool AddFriendGroup(string seatID, SeatFriendGroup group);
        ...
        /// <returns></returns>
        bool UpdateFriendGroupName(string seatID, Guid groupID, string groupName);
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        bool DeleteFriendGroup(string seatID, Guid groupID);
        ...
        /// <param name="seatID"></param>
        /// <returns></returns>
        IList<SeatFriendGroup> GetSeatFriendGroup(string seatID);
        ...
        /// <param name="groupID"></param>
        /// <returns></returns>
        bool MoveFriendToGroup(string seatID, string friendID, Guid groupID);
        ...
        /// <param name="maxCount"></param>
        /// <returns></returns>
        bool UpdateSeatGroup(Guid groupID, string groupName, int maxCount, string notification, string description);
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        IList<Seat> GetSeatsFromIDOrName(string id, string name, string cname);
        ...
        /// <param name="endTime"></param>
        /// <returns></returns>
        IList<P2SSession> GetP2SSessionsFromDB(string seatID, string userID, DateTime beginTime, DateTime endTime);
        ...
        /// <param name="friendID"></param>
        /// <returns></returns>
        bool DeleteSeatFriendAndRemoveOwner(string seatID, string friendID);
