...
namespace LiveChat.Remoting
{
    ...
    /// 		    <section name="remotingClient" type="LiveChat.Remoting.RemotingClientConfigurationHandler, LiveChat.Framework"/>
    /// 	    </sectionGroup>
    ///     </configSections>
    ///     <system.web>
    /// 	......
    ...
    public class RemotingClientConfiguration : ConfigurationBase
    {
        ...
        {
            object obj = ConfigurationManager.GetSection("livechat.framework/remotingClient");
