...
namespace LiveChat.Remoting
{
    ...
    /// <configuration>
    ///     <configSections>
    /// 	    <sectionGroup name="livechat.framework">
    /// 		    <section name="remotingServer" type="LiveChat.Remoting.RemotingServerConfigurationHandler, LiveChat.Framework"/>
    /// 	    </sectionGroup>
    ///     </configSections>
    ///     <system.web>
    /// 	......
    ...
    public class RemotingServerConfiguration : ConfigurationBase
    {
        ...
        {
            object obj = ConfigurationManager.GetSection("livechat.framework/remotingServer");
