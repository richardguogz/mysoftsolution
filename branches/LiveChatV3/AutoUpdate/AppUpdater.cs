...
namespace AutoUpdate
{
    ...
    public class AppUpdater : IDisposable
    {
        ...
        /// AppUpdater构造函数
        /// </summary>
        public AppUpdater(IntPtr handle)
        {
            this.handle = handle;
        }
        ...
        {
            string localXmlFile = Path.Combine(Application.StartupPath, "UpdateList.xml");
            ...
            this.UpdaterUrl = Path.Combine(updaterXmlFiles.GetNodeValue("//Url"), "UpdateList.xml");
            this.DownAutoUpdateFile(tempUpdatePath);

            string serverXmlFile = Path.Combine(tempUpdatePath, "UpdateList.xml");
