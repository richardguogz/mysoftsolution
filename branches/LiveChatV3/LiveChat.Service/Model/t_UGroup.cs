namespace LiveChat.Service {
        ...
        public partial class t_UGroup : Entity {
            ...
            public class _ {
                ...
                /// </summary>
                public static Field CreateID = new Field<t_UGroup>("CreateID");
                
                /// <summary>
                /// 字段名：ManagerID - 数据类型：String
                /// </summary>
                public static Field ManagerID = new Field<t_UGroup>("ManagerID");
                ...
                /// </summary>
                public static Field Description = new Field<t_UGroup>("Description");
                
                /// <summary>
                /// 字段名：Notification - 数据类型：String
                /// </summary>
                public static Field Notification = new Field<t_UGroup>("Notification");
            }
        }
    }
