...
namespace LiveChat.Client
{
    ...
    public class SortComparer<T> : IComparer<T>
    {
        ...
        {
            object value1 = ClientUtils.GetPropertyValue(x, property.PropertyName);
            object value2 = ClientUtils.GetPropertyValue(y, property.PropertyName);

            //比较两个值的大小
            int ret = ClientUtils.Compare(value1, value2);
