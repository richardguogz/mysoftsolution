...
namespace LiveChat.Service.Manager
{
    public class SessionManager
    {
        ...
        /// <returns></returns>
        public IList<P2SSession> GetUserSessionsFromDB(Seat seat, string userID, DateTime beginTime, DateTime endTime)
        {
            IList<P2SSession> list = new List<P2SSession>();

            WhereClip where = WhereClip.All;
            if (seat.SeatType == SeatType.Normal) where &= t_P2SSession._.SeatID == seat.SeatID;
